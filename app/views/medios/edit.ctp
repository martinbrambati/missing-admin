...
<?php echo $this->Form->create('Medio');?>
	<fieldset>
 		<legend><?php __('Edit Medio'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Borrar', true), array('action' => 'delete', $this->Form->value('Medio.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Medio.id'))); ?></li>
