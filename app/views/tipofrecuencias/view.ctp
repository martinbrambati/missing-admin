<div class="tipofrecuencias view">
<h2><?php  __('Tipofrecuencia');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $tipofrecuencia['Tipofrecuencia']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Name'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $tipofrecuencia['Tipofrecuencia']['name']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Dias'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $tipofrecuencia['Tipofrecuencia']['dias']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Tipofrecuencia', true), array('action' => 'edit', $tipofrecuencia['Tipofrecuencia']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Tipofrecuencia', true), array('action' => 'delete', $tipofrecuencia['Tipofrecuencia']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $tipofrecuencia['Tipofrecuencia']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($tipofrecuencia['Medio'])):?>
	...
	<?php
		$i = 0;
		foreach ($tipofrecuencia['Medio'] as $medio):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
