...
<div class="<?php echo $pluralVar;?> index">
	...
	echo "\t<tr<?php echo \$class;?>>\n";
		...
		echo "\t\t\t<?php echo \$this->Html->link(__('Ver', true), array('action' => 'view', \${$singularVar}['{$modelClass}']['{$primaryKey}'])); ?>\n";
	 	...
	 	echo "\t\t\t<?php echo \$this->Html->link(__('Borrar', true), array('action' => 'delete', \${$singularVar}['{$modelClass}']['{$primaryKey}']), null, sprintf(__('Are you sure you want to delete # %s?', true), \${$singularVar}['{$modelClass}']['{$primaryKey}'])); ?>\n";
		echo "\t\t</td>\n";
	echo "\t</tr>\n";
