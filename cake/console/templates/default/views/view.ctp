...
<div class="actions">
	<h3><?php echo "<?php __('Acciones'); ?>"; ?></h3>
	<ul>
<?php
	...
	echo "\t\t<li><?php echo \$this->Html->link(__('Listar " . $pluralHumanName . "', true), array('action' => 'index')); ?> </li>\n";
	...
	foreach ($associations as $type => $data) {
		foreach ($data as $alias => $details) {
			if ($details['controller'] != $this->name && !in_array($details['controller'], $done)) {
				echo "\t\t<li><?php echo \$this->Html->link(__('Listar " . Inflector::humanize($details['controller']) . "', true), array('controller' => '{$details['controller']}', 'action' => 'index')); ?> </li>\n";
...
echo "\t<?php
		...
		echo "\t\t<tr<?php echo \$class;?>>\n";
				...
				echo "\t\t\t\t<?php echo \$this->Html->link(__('Borrar', true), array('controller' => '{$details['controller']}', 'action' => 'delete', \${$otherSingularVar}['{$details['primaryKey']}']), null, sprintf(__('Are you sure you want to delete # %s?', true), \${$otherSingularVar}['{$details['primaryKey']}'])); ?>\n";
				echo "\t\t\t</td>\n";
			echo "\t\t</tr>\n";
